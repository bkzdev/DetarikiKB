...
- `docs/architecture/07_Wiki/Public_Publishing_Workflow_Decision.md`（2026-09-02採択。GitHub Pages custom Actions、現行MkDocs / Materialの暫定lock＋公開前Zensical合成dual-build、trusted localとhosted public gateの分離、manual production、public PR previewなし、既知正常SHA再配備を固定する。workflow実装・外部接続・実content push・実データ公開・deployは未実施）
