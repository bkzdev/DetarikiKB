...
現在の状態: Parser Phase 1・Extraction Stage A・Merge Stage B（8種entity最小merge）・Wiki renderer Phase 1に加えてPhase 2のLocation / Item / Lore / Event pageと各index、Relationship公開v1基盤・Character page内Relationship section、MkDocs local previewまで実装済み。詳細な完了履歴は `docs/project_history/Completed_PRs_2026-07.md` を参照。直近の作業内容は `TASKS.md` を参照。
