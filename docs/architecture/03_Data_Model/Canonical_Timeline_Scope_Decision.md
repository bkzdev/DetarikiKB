...
6. ~~**public projection decision**~~: `../07_Wiki/Canonical_Timeline_Public_Projection_Decision.md`で2026-09-01に推奨P1〜P7を採択した。次はpublic projection schemaとfield allowlistを合成fixtureで固定する。実データ公開・hosting・deployは未許可
