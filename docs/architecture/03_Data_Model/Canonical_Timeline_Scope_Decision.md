...
6. ~~**public projection decision / schema / projector**~~: `../07_Wiki/Canonical_Timeline_Public_Projection_Decision.md`で2026-09-01に推奨P1〜P7を採択し、専用v0.1 schema、pure projector、cross-document validator、safe aggregate reportを合成fixtureで固定した。詳細は`../07_Wiki/Canonical_Timeline_Public_Projection_Schema.md`と`../07_Wiki/Canonical_Timeline_Public_Projector.md`を参照。次はread-only preflightである。実データ公開・hosting・deployは未許可
