...
6. ~~**public projection decision / schema contract**~~: `../07_Wiki/Canonical_Timeline_Public_Projection_Decision.md`で2026-09-01に推奨P1〜P7を採択し、`../07_Wiki/Canonical_Timeline_Public_Projection_Schema.md`と専用v0.1 schemaでpublic field allowlistを合成fixtureだけで固定した。次はpure projectorとpublic-safe aggregate reportである。実データ公開・hosting・deployは未許可
