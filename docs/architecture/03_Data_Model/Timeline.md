...
採択profileのJSON表現は`Canonical_Timeline_Schema.md`と`schemas/canonical_timeline.schema.json`を正とする。v0.1は合成fixtureだけで状態・review / adoption gate・provenanceを固定したschema contractであり、実artifact生成、semantic validator、promotion、公開は未実装である。
