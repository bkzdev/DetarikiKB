...
| Phase 4.17: `evidence-index-public-id-renderer-switch`（本PR） | Evidence page見出し・anchor・Summary evidenceRefsリンクを`publicEvidenceId`中心に切り替える | **完了（本PR、実Registry投入・実promotion再開は未着手）** |
