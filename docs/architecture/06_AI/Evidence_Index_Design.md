...
| Phase 4.16: `evidence-index-public-id-registry-integration`（本PR） | Public ID Registryを`project_evidence_index_public_ids.py`へ統合し、欠落`publicEpisodeId`をRegistryから補完できるようにする | **完了（本PR、実Registry投入・renderer切替・実promotion再開は未着手）** |
