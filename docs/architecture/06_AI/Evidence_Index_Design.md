...
| Phase 4.6: `evidence-index-generation-filtering` | `build_evidence_index_candidates.py`への`--public-profile`/`--include-types`/`--exclude-types`実装、defaultでstage_direction除外 | **完了（本PR）** |
