...
| Phase 2: `evidence-index-schema-implementation` | `schemas/evidence_index.schema.json`、`docs/templates/evidence_index_template.yaml`、synthetic fixture、validator script、loader | **完了（本PR）** |
