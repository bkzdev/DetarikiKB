...
| Phase 4.7: `evidence-index-promotion-policy-implementation` | `scripts/check_evidence_index_promotion.py`（promotion check、check-only）・human review template・promotion runbook | **完了（本PR、実copyは未実装）** |
