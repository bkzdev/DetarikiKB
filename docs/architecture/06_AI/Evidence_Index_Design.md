...
| Phase 4.9: `evidence-index-promotion-copy-script`（本PR） | `scripts/promote_evidence_index.py`（promotion checkをPASSした候補のcopy script、dry-run既定・`--execute`必須） | **完了（本PR、実データcommitは未実施）** |
