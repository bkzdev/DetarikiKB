...
| Phase 4.18: `evidence-index-promotion-first-reviewed-sample-retry`（本PR） | 実Public ID Registry entry追加、実データ1 storyの初回昇格を再試行する | **完了（本PR、実Evidence Index 1件を`knowledge/evidence/stories/`へ昇格済み）** |
