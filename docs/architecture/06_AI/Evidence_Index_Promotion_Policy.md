...
| Phase 14: `evidence-index-promotion-first-reviewed-sample-retry` | projection・renderer切替完了後、実データ1 storyの初回昇格を再試行する | **完了（本PR、実Evidence Index 1件を`knowledge/evidence/stories/`へ昇格済み）** |
