...
| M6 公開準備 | 進行中 | 公開範囲、ホスティング、更新・rollback、漏えい検査を決定し、限定公開できる | 実データpublic projectionのpush前reviewと初回public input昇格まで完了。次はworkflowの実入力切替と初回実content deploy |
