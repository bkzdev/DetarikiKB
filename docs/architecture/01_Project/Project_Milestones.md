...
| M6 公開準備 | 進行中 | 公開範囲、ホスティング、更新・rollback、漏えい検査を決定し、限定公開できる | 実データpublic input昇格とworkflow実入力切替まで完了。次は初回実content deployと表示確認 |
