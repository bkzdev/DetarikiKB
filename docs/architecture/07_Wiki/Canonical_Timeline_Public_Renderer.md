...
public publishing platform / workflow、deploy gate、rollbackは`Public_Publishing_Workflow_Decision.md`で2026-09-02に採択した。次はZensical合成dual-buildを行う。実データ由来projection、mapping、report、Markdown、HTMLは引き続きcommit・deployしない。
