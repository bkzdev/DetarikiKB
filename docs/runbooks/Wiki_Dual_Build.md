...
build-only public workflowへの統合と、分離したmanual production workflow / environment gateは匿名合成input限定で完了した。次はPages artifact uploadを伴う匿名合成siteのdeploy / rollback rehearsalであり、実public inputはさらに後のgateまで扱わない。
