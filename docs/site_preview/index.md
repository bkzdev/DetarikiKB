...
MkDocs MaterialとZensicalで継続検証するための最小合成構成です。
...
- GitHub Pages / Cloudflare Pages等の公開設定、artifact upload、deployは実装していません。
...
commit済み合成previewのMkDocs / Zensical strict buildは
`docs/runbooks/Wiki_Dual_Build.md`を参照してください。
...
- `docs/runbooks/Wiki_Dual_Build.md` — MkDocs / Zensical dual-build手順
